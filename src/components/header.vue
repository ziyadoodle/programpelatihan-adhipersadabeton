<template>
    <header
        class="z-10 py-4 bg-white shadow-md animate__animated animate__fadeInDown animate__slow"
    >
        <div
            class="container flex items-center justify-between h-full px-6 mx-auto text-red-600"
        >
            <!-- Mobile hamburger -->
            <button
